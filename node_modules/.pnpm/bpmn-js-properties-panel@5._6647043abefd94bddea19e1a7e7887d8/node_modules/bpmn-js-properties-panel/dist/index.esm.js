...
function isZeebeServiceTask(element) {
  ...
  if (isAny$1(element, ['bpmn:BusinessRuleTask', 'bpmn:ScriptTask']) && !getTaskDefinition$3(element)) {
    return false;
  }
  return true;
}
...
function CalledDecisionProps(props) {
  ...
  if (getBindingType(element, 'zeebe:CalledDecision') === 'versionTag') {
    entries.push({
      id: 'versionTag',
      component: withProps(VersionTag$3, {
        type: 'zeebe:CalledDecision'
      }),
      isEdited: isTextFieldEntryEdited
    });
...
function addFactory$a({
  ...
  return function (event) {
    ...
    const executionListener = createElement('zeebe:ExecutionListener', getDefaultListenerProps(element), executionListeners, bpmnFactory);
...
const TooltipProvider$1 = {
  'group-assignmentDefinition': element => {
    const translate = useService('translate');
    return jsxs("div", {
      children: [translate('Define who the task is assigned to. One or all of the following attributes can be specified simultaneously. '), jsx("a", {
  ...
  'group-condition': element => {
    const translate = useService('translate');
    return jsxs("div", {
      children: [translate('Define a boolean condition expression that defines when this flow is taken. '), jsx("a", {
  ...
  'group-userTaskImplementation': element => {
    const translate = useService('translate');
    return jsxs("div", {
      children: [translate('Implement a user task managed by Zeebe. To add a custom implementation, use a job worker. '), jsx("a", {
  ...
  'group-message': element => {
    ...
    if (is(element, 'bpmn:ReceiveTask')) {
      return jsxs("div", {
        children: [translate('Define the name of the message (e.g. '), jsx("code", {
          children: "Money collected"
        }), translate(') and the '), jsx("code", {
          children: "correlationKey"
        }), translate(' expression (e.g. '), jsx("code", {
          children: "= orderId"
        }), translate(')'), translate(' to subscribe to. '), translate('Learn more how to '), jsx("a", {
    ...
    return jsxs("div", {
      children: [translate('Define the name of the message (e.g. '), jsx("code", {
        ...
        children: "= orderId"
      }), translate(')'), translate(' to subscribe to. '), jsx("a", {
  ...
  'group-error': element => {
    const translate = useService('translate');
    return jsxs("div", {
      children: [translate('Define an error code (e.g. '), jsx("code", {
  ...
  'group-inputs': element => {
    const translate = useService('translate');
    return jsxs("div", {
      children: [translate('Create a new local variable in the scope of this task. '), jsx("a", {
  ...
  'group-outputs': element => {
    const translate = useService('translate');
    return jsxs("div", {
      children: [translate('Customize how result variables are merged into the global scope of the process instance. '), jsx("a", {
