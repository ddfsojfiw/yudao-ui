  ...
  var Upload = vue.defineComponent({
    ...
    render: function render() {
      ...
      return vue.createVNode("div", {
        ...
        "default": function _default() {
          return [((_this$$slots$default = (_this$$slots = _this.$slots)["default"]) === null || _this$$slots$default === void 0 ? void 0 : _this$$slots$default.call(_this$$slots)) || (['text', 'picture'].indexOf(_this.listType) === -1 ? vue.createVNode(vue.resolveComponent("ElIcon"), null, {
            "default": function _default() {
      ...
      syncForm: function syncForm() {
        ...
        if (this.options.appendValue !== false) {
          Object.keys(this.appendData).reduce(function (initial, field) {
            if (fields.indexOf(field) === -1) {
              initial[field] = vue.toRef(_this3.appendData, field);
            }
        ...
        fields.reduce(function (initial, field) {
          var ctx = (_this3.fieldCtx[field] || []).filter(function (ctx) {
            return !_this3.isIgnore(ctx.rule);
  ...
  function useContext(Handler) {
    extend(Handler.prototype, {
      ...
      watchCtx: function watchCtx(ctx) {
        ...
        ctx.refRule['__$title'] = vue.computed(function () {
        ...
        ctx.refRule['__$info'] = vue.computed(function () {
        ...
        ctx.refRule['__$validate'] = vue.computed(function () {
        ...
        this.bus.$once('load-end', function () {
          ...
          Object.keys(computedRule).forEach(function (k) {
            ...
            var computedValue = vue.computed(function () {
            ...
            ctx.watch.push(vue.watch(computedValue, function (n) {
              oldValue = n;
              setTimeout(function () {
                callback(n);
              });
          ...
          var checkCondition = function checkCondition(item) {
            ...
            var _loop = function _loop(i) {
              ...
              if (one.mode) {
                ...
                flag = new Function('$condition', '$val', '$form', '$group', '$rule', "with($form){with(this){with($group){ return $condition['".concat(one.condition, "'](").concat(field, ", ").concat(compare ? compare : '$val', "); }}}")).call(_this2.api.form, condition, one.value, _this2.api.top.form, group ? _this2.subRuleData[group.id] || {} : {}, ctx.rule);
              }
  ...
  function FormCreateFactory(config) {
    ...
    extend(FormCreate.prototype, {
      init: function init() {
        ...
        if (this.isSub()) {
          this.unwatch.push(vue.watch(function () {
      ...
      globalVarDriver: function globalVarDriver(id) {
        ...
        if (option) {
          ...
          if (handle) {
            return deepGet(invoke(function () {
              return handle(_this5.get || function () {
                return _this5.getLoadData.apply(_this5, arguments);
              }, _this5.$handle.api);
            }), split);
          }
        }
      ...
      watchLoadData: function watchLoadData(fn, wait) {
        ...
        var get = function get(id, def) {
          ...
          var un = vue.watch(data, function (n) {
            callback();
          });
  ...
  var required = {
    ...
    load: function load(inject, rule, api) {
      ...
      if (val.required === false) {
        ...
        var title = rule.__fc__.refRule.__$title.value;
